...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_12035 = 0;while(true){
if((i_12035 < arr.length))
{(arr[i_12035] = null);
{
...
{var i_12042 = (self__.level + 1);while(true){
if((i_12042 <= (new_level + 1)))
{(update[i_12042] = self__.header);
{
var G__12043 = (i_12042 + 1);
i_12042 = G__12043;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_12044 = 0;while(true){
if((i_12044 <= self__.level))
{var links_12045 = (update[i_12044]).forward;if(((links_12045[i_12044]) === x__$1))
{(links_12045[i_12044] = (x__$1.forward[i_12044]));
{
var G__12046 = (i_12044 + 1);
i_12044 = G__12046;
continue;
}
} else
{{
var G__12047 = (i_12044 + 1);
i_12044 = G__12047;
continue;
}
}
