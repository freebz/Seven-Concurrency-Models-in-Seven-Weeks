...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_12070 = 0;while(true){
var m_12071 = cljs.core.async.impl.dispatch.tasks.pop();if((m_12071 == null))
{} else
{m_12071.call(null);
if((count_12070 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__12072 = (count_12070 + 1);
count_12070 = G__12072;
continue;
}
} else
{}
