...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_12154 = 0;while(true){
var m_12155 = cljs.core.async.impl.dispatch.tasks.pop();if((m_12155 == null))
{} else
{m_12155.call(null);
if((count_12154 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__12156 = (count_12154 + 1);
count_12154 = G__12156;
continue;
}
} else
{}
