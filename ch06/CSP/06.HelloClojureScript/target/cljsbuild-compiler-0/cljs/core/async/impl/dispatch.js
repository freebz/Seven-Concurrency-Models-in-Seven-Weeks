...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_12134 = 0;while(true){
var m_12135 = cljs.core.async.impl.dispatch.tasks.pop();if((m_12135 == null))
{} else
{m_12135.call(null);
if((count_12134 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__12136 = (count_12134 + 1);
count_12134 = G__12136;
continue;
}
} else
{}
