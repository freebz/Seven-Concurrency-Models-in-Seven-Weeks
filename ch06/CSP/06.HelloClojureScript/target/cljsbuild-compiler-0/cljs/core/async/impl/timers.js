...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_12099 = 0;while(true){
if((i_12099 < arr.length))
{(arr[i_12099] = null);
{
var G__12100 = (i_12099 + 1);
i_12099 = G__12100;
continue;
}
} else
...
{var i_12106 = (self__.level + 1);while(true){
if((i_12106 <= (new_level + 1)))
{(update[i_12106] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_12108 = 0;while(true){
if((i_12108 <= self__.level))
{var links_12109 = (update[i_12108]).forward;if(((links_12109[i_12108]) === x__$1))
{(links_12109[i_12108] = (x__$1.forward[i_12108]));
{
var G__12110 = (i_12108 + 1);
i_12108 = G__12110;
continue;
}
} else
{{
var G__12111 = (i_12108 + 1);
i_12108 = G__12111;
continue;
}
}
