...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t12140 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t12140 = (function (val,box,meta12141){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t12140.cljs$lang$type = true;
cljs.core.async.impl.channels.t12140.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t12140";
cljs.core.async.impl.channels.t12140.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"cljs.core.async.impl.channels/t12140");
});
cljs.core.async.impl.channels.t12140.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t12140.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12142){var self__ = this;
var _12142__$1 = this;return self__.meta12141;
});
cljs.core.async.impl.channels.t12140.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12142,meta12141__$1){var self__ = this;
var _12142__$1 = this;return (new cljs.core.async.impl.channels.t12140(self__.val,self__.box,meta12141__$1));
});
cljs.core.async.impl.channels.__GT_t12140 = (function __GT_t12140(val__$1,box__$1,meta12141){return (new cljs.core.async.impl.channels.t12140(val__$1,box__$1,meta12141));
});
}
return (new cljs.core.async.impl.channels.t12140(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_12143 = self__.takes.pop();if((taker_12143 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_12143))
{var take_cb_12144 = cljs.core.async.impl.protocols.commit.call(null,taker_12143);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_12144,taker_12143){
return (function (){return take_cb_12144.call(null,null);
});})(take_cb_12144,taker_12143))
);
} else
{}
{
